...
| Tarefa | Grau de Sucesso | Total de Erros | Tipos de Erros                                                | Tempo Necessário | Grau de Satisfação |
| ------ | --------------- | -------------- | ------------------------------------------------------------- | ---------------- | ------------------ |
| 1      | Sucesso  | 0              | (elogiou que o botao de gravar realmente iniciava uma gravacao)    | 11s               | Satisfeito   |
| 1      | Sucesso  | 0              | (elogiou que a visualizacao em tempo real se mexia)    | 15s               | Satisfeito    |
| 2      | Sucesso    | 0              | (elogiou o reset de posicao)                                                            | 32s               | Satisfeito    |
| 3      | Falha  | 1              | (1) Queria encontrar a gravacao de movimentos mas nao a encontrou | -              | Insatisfeito Confuso  |

### Gabriel Vertamatti
| Tarefa | Grau de Sucesso | Total de Erros | Tipos de Erros                                                | Tempo Necessário | Grau de Satisfação |
| ------ | --------------- | -------------- | ------------------------------------------------------------- | ---------------- | ------------------ |
| 1      | Sucesso  | 0              | (Leu as seções com atenção).    | 28s              | Satisfeito    |
| 2      | Sucesso   | 0              |          |    35seg            | Satisfeito    |
| 3      | Sucesso   | 1              |     (1) Não entendeu o que era "Base Móvel" e procurou descrição (não havia).          |    1 min          | Satisfeito    |
| 4      | Não Tentou  | 0              | - | -              | -  |
...
## Teste Livia 
https://youtu.be/5kVGo-1uOv0
## Teste Gabriel Vertamatti
https://youtu.be/Qqd3Llo4kJY
